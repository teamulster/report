...
The development process included some beneficial agile development methods.
The project team used daily stand-ups to share their individual work progress and inform about current difficulties.
A shortly conclusion meeting at the end of every day was hold to summarize the work effort and supported a productive communication.
A kanban board added organization clarity and displayed the responsibility for every identified task.
At the beginning of the week, we started with a retrospection, followed by identification the mile stone for the week.
The team named a scrum master, who initialized and guaranteed the realization of the chosen methods. Furthermore a lead of programming was chosen from the team depending on greatest development experience.
With two approvals declared necessary for an pull request to merge, the majority of the project group approved changes. Therefore every member constantly kept the overview of the projects current progression.
