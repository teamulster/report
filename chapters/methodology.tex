...
Figure \ref{fig:user_journey} illustrates the user interface during two different stages in the core process of the soHappy app.

\begin{figure}
  \includegraphics[width=\linewidth]{figures/user_journey.jpg}
  \caption{Example of two stages during the soHappy process. The left image shows the state in which a face has not been detected yet, while the right image depicts the state where a smile has been detected.}
